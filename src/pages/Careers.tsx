    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <CareerCard
            ...
            />
            <CareerCard
              image="https://images.pexels.com/photos/5561925/pexels-photo-5561925.jpeg?auto=compress&cs=tinysrgb&w=800"
              delay="400"
              isVisible={isVisible}
            />
            <CareerCard
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                We make an unwavering commitment to our drivers and staff so they feel
                appreciated for the contributions they make every day to our country. They are
                the daily ambassadors of our services across the world.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              At DM World Transportation, we're always looking for talented individuals who share
              our commitment to excellence and customer service. Whether you're an experienced
              driver or looking for an office position, we offer competitive compensation,
