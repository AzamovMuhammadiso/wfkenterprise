  ...
  const testimonials = [
    {
      ...
      image: 'https://images.pexels.com/photos/1490844/pexels-photo-1490844.jpeg?auto=compress&cs=tinysrgb&w=400',
      quote:
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Charles began his career in 1957 after completing truck driving school in
                  Chicago. He started out as a driver for Schneider National Carriers and has
                  since accumulated a vast range of experience across various types of
                  transportation, including dry vans, ocean containers, refrigerated vans,
                  flatbeds, and tankers. He maintains his commercial driver's license (CDL) and
                  continues to be active in the industry.
                </p>
                <p>
                  In 2008, Charles founded his first trucking company, specializing in loading
                  and unloading airplanes at O'Hare Airport in Chicago and in 2022 Charles
                  acquired DM World Transportation LLC. With his extensive experience and
                  knowledge, Charles is now focused on growing the business and better
                  transportation services through his company.
                </p>
              </div>
            </div>
            ...
            {groupedRegions.map((column, columnIndex) => (
              <div key={columnIndex} className="space-y-3">
                {column.map((region, index) => (
                  <div
                    key={region.name}
                    className={`flex items-center space-x-2 transition-all duration-500 delay-${index * 50} ${
